...
const SUPPORTED = ["USD", "PHP", "EUR", "GBP", "JPY", "SGD", "AUD", "CAD", "INR", "AED"]

// Country (ISO-3166 alpha-2) → currency. Unlisted countries fall back to USD.
const COUNTRY_CURRENCY: Record<string, string> = {
  PH: "PHP", US: "USD", GB: "GBP", JP: "JPY", SG: "SGD", AU: "AUD",
  CA: "CAD", IN: "INR", AE: "AED",
...
const DEFAULT_COUNTRY = (process.env.NEXT_PUBLIC_DEFAULT_COUNTRY ?? "PH").toUpperCase()

// Last-resort static rates if the FX API is unreachable, so pricing always renders.
const FALLBACK_RATES: Record<string, number> = {
  USD: 1, PHP: 57, EUR: 0.92, GBP: 0.79, JPY: 156, SGD: 1.35, AUD: 1.52, CAD: 1.37, INR: 83, AED: 3.67,
}
