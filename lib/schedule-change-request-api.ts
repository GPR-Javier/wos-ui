...
export const scheduleChangeRequestApi = {
  create: (body: CreateChangeRequestPayload) =>
    api
      .post<ScheduleChangeRequest>("/schedule-change-requests", body)
      .then((r) => r.data),
  ...
  cancelMine: (id: number) =>
    api
      .post<ScheduleChangeRequest>(`/schedule-change-requests/${id}/cancel`)
      .then((r) => r.data),
  ...
  listAll: (
    ...
    api
      .get<PageResponse<ScheduleChangeRequest>>("/schedule-change-requests", {
        params: { page: 0, size: 20, ...params },
      })
      .then((r) => r.data),
  ...
  approve: (id: number, reviewNote?: string) =>
    api
      .post<ScheduleChangeRequest>(`/schedule-change-requests/${id}/approve`, {
  ...
  reject: (id: number, reviewNote?: string) =>
    api
      .post<ScheduleChangeRequest>(`/schedule-change-requests/${id}/reject`, {
        reviewNote: reviewNote ?? null,
      })
      .then((r) => r.data),
}
